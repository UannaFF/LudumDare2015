...
func _ready():
	spiceText = load("res://images/spice.tex")
	chispasText = load("res://images/chispas.tex")
	saleroText = load("res://images/salero.tex")
	spiceCloud = load("res://res/spiceAttack.res")
